...
class EnterpriseProperties{
    ...
    init(){
        ...
        let ent3 = Enterprise(pId: 3, pName: "Bacompany House", pDescription: ent3desc, pImageName: "BacompanyHouse.png")
        ...
        let ent4 = Enterprise(pId: 4, pName: "Mr Always Young", pDescription: ent4desc, pImageName: "MrAlwaysYoung.png")
        ...
        let ent6 = Enterprise(pId: 6, pName: "Time News Central", pDescription: ent6desc, pImageName: "TimeNewsCentral.png")
        ...
        let ent7 = Enterprise(pId: 7, pName: "B&C", pDescription: ent7desc, pImageName: "B&C.png")
        ...
        let ent9 = Enterprise(pId: 9, pName: "Dumont Aircrafts", pDescription: ent9desc, pImageName: "DumontAircrafts.png")
        ...
        let ent10 = Enterprise(pId: 10, pName: "Fastex SA", pDescription: ent10desc, pImageName: "FastexSA.png")
